...
% % Representation = Representation(index{ind},:);
% 
% 
...
predictLabel= HyperCut(A_init, nCluster, numView);
H = labelToOneHot(predictLabel);
w = ones(1,numView*nCluster);
[Dv,De,Dv32,De2] = get_degrees(H,w);
AA = getA(Dv,H,diag(w),De);